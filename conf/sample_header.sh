...
INPUT_BWA="fastq"
MODULE_BWA="${NG_JAVA} ${NG_SAMTOOLS} ${NG_IGVTOOLS} ${NG_R} ${NG_IMAGEMAGIC} ${NG_PICARD} ${NG_SAMSTAT} ${NG_UCSCTOOLS} ${NG_BEDTOOLS} ${NG_BWA}"
PATH_BWA=
...
INPUT_BOWTIE2="fastq"
MODULE_BOWTIE2="${NG_JAVA} ${NG_SAMTOOLS} ${NG_IGVTOOLS} ${NG_R} ${NG_IMAGEMAGIC} ${NG_PICARD} ${NG_SAMSTAT} ${NG_UCSCTOOLS} ${NG_BEDTOOLS} ${NG_BOWTIE2}"
PATH_BOWTIE2=$PATH_IGVTOOLS:$PATH_PICARD:$PATH_SAMSTAT

##############################################################
# Masai (0.7.1)
# http://www.seqan.de/projects/masai/
WALLTIME_MASAI=72:00:00
MEMORY_MASAI=60
CPU_MASAI=1
NODES_MASAI="nodes=1:ppn=1"
INPUT_MASAI="fastq"
MODULE_MASAI="${NG_JAVA} ${NG_SAMTOOLS} ${NG_IGVTOOLS} ${NG_R} ${NG_IMAGEMAGIC} ${NG_PICARD} ${NG_SAMSTAT} ${NG_UCSCTOOLS} ${NG_BEDTOOLS} ${NG_MASAI}"
PATH_MASAI=$PATH_IGVTOOLS:$PATH_PICARD:$PATH_SAMSTAT
...
INPUT_TOPHAT="fastq"
MODULE_TOPHAT="${NG_BOOST} ${NG_JAVA} ${NG_PYTHON} ${NG_R} ${NG_BOWTIE2} ${NG_SAMTOOLS} ${NG_IMAGEMAGIC} ${NG_IGVTOOLS} ${NG_PICARD} ${NG_SAMSTAT} ${NG_BEDTOOLS} ${NG_RNASEQC} ${NG_TOPHAT}"
