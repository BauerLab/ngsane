...
# date: March 2014echo ">>>>> [TEMPLATE purpose]"
echo ">>>>> startdate "`date`
...
mkdir -p $OUTDIR# delete old bam files unless attempting to recover
...
for GTF in  "GTF" "GTF_masked"
  ...
  do
      ...
      for MODE in "union" "intersection-strict" "intersection-nonempty"
         ...
         do                 for ATTR in "gene_id" "transcript_id"
